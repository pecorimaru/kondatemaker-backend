...
from app.types.api.ingred import (
    SubmitAddIngredRequest,
    SubmitAddIngredResponse,
    SubmitEditIngredRequest,
    SubmitEditIngredResponse,
    SubmitDeleteIngredResponse,
    SubmitAddIngredUnitConvRequest,
    SubmitAddIngredUnitConvResponse,
    SubmitUpdateIngredUnitConvRequest,
    SubmitUpdateIngredUnitConvResponse,
    SubmitDeleteIngredUnitConvResponse,
)
...
def submit_edit_ingred_unit_conv(request: SubmitUpdateIngredUnitConvRequest, db: Session = Depends(get_db), token: str = Depends(oauth2_scheme)):
    ...
    return SubmitUpdateIngredUnitConvResponse(
        status_code = status.HTTP_200_OK,
        message = msg.get_message(msg.MI0003_EDIT_SUCCESSFUL),
        new_ingred_unit_conv = new_ingred_unit_conv,
    )
