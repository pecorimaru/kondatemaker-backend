...
from app.types.api.setting import (
    SubmitEditUserNmRequest,
    SubmitEditUserNmResponse,
    SubmitChangePasswordRequest,
    SubmitChangePasswordResponse,
    SubmitDeleteUserResponse,
    SubmitEditGroupNmRequest,
    SubmitEditGroupNmResponse,
    SubmitMemberInviteRequest,
    SubmitMemberInviteResponse,
    JoinGroupRequest,
    JoinGroupResponse,
    ChangeGroupRequest,
    ChangeGroupResponse,
...
async def submit_member_invite(request: SubmitMemberInviteRequest, db: Session = Depends(get_db), token: str = Depends(oauth2_scheme)):
    login_info = decode_token(token)
